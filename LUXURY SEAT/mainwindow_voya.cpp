...
MainWindow_voya::MainWindow_voya(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::MainWindow_voya)
{bool test;
...
MainWindow_voya::~MainWindow_voya()
{
    delete ui;
}

void MainWindow_voya::update_label()
{
...
void MainWindow_voya::on_addbutt_clicked()
{
...
void MainWindow_voya::on_pushsupp_clicked()
{Voyages E1;
...
void MainWindow_voya::on_pushButton_2_clicked()
{

}

void MainWindow_voya::on_pushButton_clicked()
{Voyages E2;
...
void MainWindow_voya::on_rechbtt_clicked()
{ Voyages E3;
...
void MainWindow_voya::on_EXPORTING_clicked()
{
...
void MainWindow_voya::on_filtrem_clicked()
{Voyages E;
...
void MainWindow_voya::on_filtrep_clicked()
{
    Voyages E;
        ui->tablevoy->setModel(E.afficher(2));
}

void MainWindow_voya::on_adduser_clicked()
{
...
void MainWindow_voya::on_pushsupper_clicked()
{
...
void MainWindow_voya::on_ban_clicked()
{
...
void MainWindow_voya::on_afficherstat_clicked()
{
...
void MainWindow_voya::on_annulerbt_2_clicked()
{
...
void MainWindow_voya::on_rembbtn_2_clicked()
{
    int calc,rem;
        rem=0;
        QString id;

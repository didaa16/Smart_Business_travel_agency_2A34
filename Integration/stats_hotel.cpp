...
#include "ui_stats_hotel.h"

stats_hotel::stats_hotel(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::stats_hotel)
{
    ui->setupUi(this);
}

stats_hotel::~stats_hotel()
{
    delete ui;
}
void stats_hotel::pie()
{
...
void stats_hotel::on_pushButton_9_clicked()
{
   stats_hotel::hide();
}

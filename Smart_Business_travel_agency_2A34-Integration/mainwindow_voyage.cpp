...
#include "ui_mainwindow_voyage.h"
#include "voyages.h"
#include "QMessageBox"
...
MainWindow_voyage::MainWindow_voyage(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MainWindow_voyage)
{bool test;
...
MainWindow_voyage::~MainWindow_voyage()
{
    delete ui;
}

void MainWindow_voyage::on_addbutt_clicked()
{
...
void MainWindow_voyage::on_pushsupp_clicked()
{Voyages E1;
...
void MainWindow_voyage::on_pushButton_2_clicked()
{

}

void MainWindow_voyage::on_pushButton_clicked()
{Voyages E2;
...
void MainWindow_voyage::on_rechbtt_clicked()
{ Voyages E3;
...
void MainWindow_voyage::on_EXPORTING_clicked()
{
...
void MainWindow_voyage::on_filtrem_clicked()
{Voyages E;
...
void MainWindow_voyage::on_filtrep_clicked()
{
    Voyages E;
        ui->tablevoy->setModel(E.afficher(2));
}

void MainWindow_voyage::on_adduser_clicked()
{
...
void MainWindow_voyage::on_pushsupper_clicked()
{
...
void MainWindow_voyage::on_ban_clicked()
{
...
void MainWindow_voyage::on_afficherstat_clicked()
{
...
void MainWindow_voyage::on_annulerbt_2_clicked()
{
...
void MainWindow_voyage::on_rembbtn_2_clicked()
{
    int calc,rem;
        rem=0;
        QString id;

...
mainwindow_visa::mainwindow_visa(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::mainwindow_visa)
{
    ui->setupUi(this);
    ui->setupUi(this);
...
mainwindow_visa::~mainwindow_visa()
{
    delete ui;
}
void mainwindow_visa::on_pushButton_2_clicked()
{
...
void mainwindow_visa::on_pushButton_3_clicked()
{
    QSqlQuery req;
...
void mainwindow_visa::on_pushButton_4_clicked()
{
...
void mainwindow_visa::on_pushButton_clicked()
{
...
void mainwindow_visa::on_pushButton_5_clicked()
{
...
void mainwindow_visa::on_pushButton_6_clicked()
{
    QSqlQueryModel * model = new QSqlQueryModel();
...
void mainwindow_visa::on_lineEdit_12_textChanged(const QString &arg1)
{
    ui->tableView_2->setModel(a.chercher(arg1));
}
void mainwindow_visa::on_pushButton_7_clicked()
{
    QPrinter printer;
...
void mainwindow_visa::on_tableView_2_clicked(const QModelIndex &index)
{
...
void mainwindow_visa::on_pushButton_15_clicked()
{
    QString val,x;
...
void mainwindow_visa::on_pushButton_8_clicked()
{
...
void mainwindow_visa::on_pushButton_9_clicked()
{
